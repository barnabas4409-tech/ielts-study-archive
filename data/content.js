...
window.IELTS_CONTENT = {
  ...
  writing: {
    ...
    taskOneToolkit: {
      ...
      movement: [
        { meaning: "증가", verb: "increase", past: "increased", participle: "increased", noun: "an increase" },
        { meaning: "증가", verb: "rise", past: "rose", participle: "risen", noun: "a rise" },
        { meaning: "증가", verb: "grow", past: "grew", participle: "grown", noun: "a growth" },
        { meaning: "증가", verb: "climb", past: "climbed", participle: "climbed", noun: "an upward trend" },
        { meaning: "증가", verb: "go up", past: "went up", participle: "gone up", noun: "—" },
        { meaning: "급증", verb: "boom", past: "boomed", participle: "boomed", noun: "a boom" },
        { meaning: "감소", verb: "decrease", past: "decreased", participle: "decreased", noun: "a decrease" },
        { meaning: "감소", verb: "fall", past: "fell", participle: "fallen", noun: "a fall" },
        { meaning: "감소", verb: "drop", past: "dropped", participle: "dropped", noun: "a drop" },
        { meaning: "감소", verb: "decline", past: "declined", participle: "declined", noun: "a decline" },
        { meaning: "감소", verb: "reduce", past: "reduced", participle: "reduced", noun: "a reduction" },
        { meaning: "감소", verb: "go down", past: "went down", participle: "gone down", noun: "a downward trend" },
        { meaning: "급감", verb: "plunge", past: "plunged", participle: "plunged", noun: "a plunge" },
        { meaning: "변화 없음", verb: "do not change", past: "did not change", participle: "—", noun: "no change" },
        { meaning: "평탄해짐", verb: "level out", past: "levelled out", participle: "levelled out", noun: "a levelling out" },
        { meaning: "평탄해짐", verb: "level off", past: "levelled off", participle: "levelled off", noun: "a levelling off" },
        { meaning: "안정 유지", verb: "remain stable", past: "remained stable", participle: "remained stable", noun: "—" },
        { meaning: "변동", verb: "fluctuate", past: "fluctuated", participle: "fluctuated", noun: "a fluctuation" },
        { meaning: "변화", verb: "change", past: "changed", participle: "changed", noun: "a change" },
        { meaning: "최고점", verb: "peak", past: "peaked", participle: "peaked", noun: "a peak" },
        { meaning: "최고점", verb: "reach the highest point", past: "reached the highest point", participle: "—", noun: "the highest point" },
        { meaning: "최저점", verb: "bottom out", past: "bottomed out", participle: "bottomed out", noun: "a bottom" },
        { meaning: "최저점", verb: "reach the lowest point", past: "reached the lowest point", participle: "—", noun: "the lowest point" },
      ],
      degrees: [
        { level: "약간·느린", adjective: "slight", adverb: "slightly" },
        { level: "약간·느린", adjective: "slow", adverb: "slowly" },
        { level: "약간·느린", adjective: "minimal", adverb: "minimally" },
        { level: "점진적·꾸준한", adjective: "gradual", adverb: "gradually" },
        { level: "점진적·꾸준한", adjective: "steady", adverb: "steadily" },
        { level: "점진적·꾸준한", adjective: "moderate", adverb: "moderately" },
        { level: "빠른·큰", adjective: "sharp", adverb: "sharply" },
        { level: "빠른·큰", adjective: "steep", adverb: "steeply" },
        { level: "빠른·큰", adjective: "significant", adverb: "significantly" },
        { level: "빠른·큰", adjective: "dramatic", adverb: "dramatically" },
        { level: "빠른·큰", adjective: "considerable", adverb: "considerably" },
        { level: "갑작스러운", adjective: "sudden", adverb: "suddenly" },
      ],
      generalExpressions: [
        { meaning: "대략", expressions: "approximately / around / about / roughly / nearly" },
        { meaning: "기준보다 적음", expressions: "slightly less than / just under / well under" },
        { meaning: "기준보다 많음", expressions: "slightly more than / just over / well over" },
        { meaning: "보여주다", expressions: "show / illustrate / demonstrate / display / present / indicate / represent" },
        { meaning: "비교하다", expressions: "compared to / compared with / in comparison with + noun" },
        { meaning: "차지하다·구성하다", expressions: "account for / make up / consist of / constitute" },
      ],
      timePlacePrepositions: [
        { preposition: "at", time: "시각·순간·정확한 시간", place: "지점·번지가 있는 주소·좁은 공간" },
        { preposition: "on", time: "요일·날짜·기념일", place: "표면·거리·~ 위" },
        { preposition: "in", time: "월·연도·세기·긴 기간", place: "입체 공간·도시·국가·~ 안" },
      ],
      numbers: [
        { form: "to + figure", meaning: "~까지: 도착한 수치", example: "In 2010, the rate of unemployment rose to 20 per cent." },
        { form: "by + amount", meaning: "~만큼: 변화량", example: "In 2010, interest rates fell by 2 per cent, from 6 to 4 per cent." },
        { form: "with + figure", meaning: "~으로: 수치·비율을 동반", example: "Tom won the student leader election with 70 per cent of the vote." },
        { form: "at + figure", meaning: "~로: 특정 수치", example: "The unemployment rate peaked in 2011, at 12 per cent." },
      ],
      measurementNouns: [
        { type: "수", expressions: "the number of", alternative: "the quantity of / the figure for" },
        { type: "양", expressions: "the amount of / the volume of", alternative: "the quantity of / the figure for" },
        { type: "비율", expressions: "the percentage of / the ratio of / the rate of / the proportion of", alternative: "the figure for" },
      ],
      fractions: [
        { percentage: "10%", fraction: "1/10", expression: "one tenth / a tenth" },
        { percentage: "20%", fraction: "1/5", expression: "one fifth / a fifth" },
        { percentage: "22%", fraction: "—", expression: "slightly more than a fifth" },
        { percentage: "25%", fraction: "1/4", expression: "one quarter / a quarter" },
        { percentage: "31%", fraction: "—", expression: "slightly less than a third" },
        { percentage: "33.3%", fraction: "1/3", expression: "one third / a third" },
        { percentage: "50%", fraction: "1/2", expression: "one half / a half" },
        { percentage: "66.6%", fraction: "2/3", expression: "two thirds" },
        { percentage: "75%", fraction: "3/4", expression: "three quarters" },
        { percentage: "80%", fraction: "4/5", expression: "four fifths", note: "원자료의 four quarters를 정확한 표현으로 수정" },
        { percentage: "95%", fraction: "—", expression: "the vast majority / almost all" },
        { percentage: "100%", fraction: "—", expression: "all" },
      ],
      referencePhrases: [
        { label: "사람들", expressions: "Koreans / Korean people / people in Korea / people living in Korea" },
        { label: "기간", expressions: "from 2000 to 2010 / from 2000 until 2010 / between 2000 and 2010 / over a period of 10 years / over a period of one decade" },
      ],
      overviews: [
